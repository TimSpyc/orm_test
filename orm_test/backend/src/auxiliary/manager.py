...
class GeneralManager:
            ...
            if db_column in invalid_key_list:
                raise ValueError(
                    f'''
                        ...
                        creator_user is an extra kwarg because its
    ...
    @updateCache
    def update(self, creator_user: int, **kwargs: any):
        """
        Update the current instance with new data, 
        uploads to db and refresh the cache.

        Args:
            creator_user (int): The ID of the user who is making the update.
    ...
    def __writeDataData(
        ...
        new_data = {
            ...
            **{
                'date': datetime.now(),
                'creator':User.objects.get(id=creator_user),
    ...
    def deactivate(self, creator_user: int) -> None:
        """
        ...
        self.update(creator_user, active=False)
    ...
    @classmethod
    @createCache
    def create(cls, creator_user: int, **kwargs: any) -> object:
        """
