# Generated by Django 4.2.1 on 2023-08-27 11:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('asset_item_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.assetitemgroup')),
            ],
        ),
        migrations.CreateModel(
            name='AssetSiteGroup',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('asset_item_site_connection_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.assetitemsiteconnectiongroup')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
                ('permission_type', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.permissiontype')),
                ('permission_user_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.permissionusergroup')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
                ('permission_master_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.permissionmastergroup')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=255)),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
                ('file_group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='backend.filegroup')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
                ('customer_norm', models.ManyToManyField(blank=True, to='backend.normgroup')),
                ('material_alloy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='backend.materialalloygroup')),
                ('material_alloy_treatment', models.ManyToManyField(blank=True, to='backend.materialalloytreatmentgroup')),
                ('material_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.materialgroup')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
                ('file_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.filegroup')),
                ('file_type', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.filetype')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('change_request_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.changerequestgroup')),
                ('project_user_role', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.projectuserrole')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('change_request_risk_category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.changerequestriskcategory')),
                ('change_request_risk_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.changerequestriskgroup')),
                ('change_request_risk_impact', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.changerequestriskimpact')),
                ('change_request_risk_probability', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.changerequestriskprobability')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('description', models.TextField(null=True)),
                ('change_request_file_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.changerequestfilegroup')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('change_request_feasibility_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.changerequestfeasibilitygroup')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('description', models.TextField()),
                ('change_request_cost_category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.changerequestcostcategory')),
                ('change_request_cost_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.changerequestcostgroup')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(null=True)),
                ('after_change_image', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='after_change_image', to='backend.filegroup')),
                ('after_change_part', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='after_change_part', to='backend.partgroup')),
                ('before_change_image', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='before_change_image', to='backend.filegroup')),
                ('before_change_part', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='before_change_part', to='backend.partgroup')),
                ('change_request_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.changerequestgroup')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_site_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.assetsitegroup')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('grid_size', models.PositiveSmallIntegerField(default=3, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(3)])),
                ('asset_item_site_connection_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.assetitemsiteconnectiongroup')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
            ],
            options={
                'unique_together': {('asset_item_site_connection_group', 'user', 'grid_size')},
            },
        ),
        migrations.CreateModel(
            name='AssetLayout',
            fields=[
                ...
                ('date', models.DateTimeField()),
                ('active', models.BooleanField(default=True)),
                ('height', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(3)])),
                ('width', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(3)])),
                ('x_coordinate', models.PositiveSmallIntegerField(default=0)),
                ('y_coordinate', models.PositiveSmallIntegerField(default=0)),
                ('asset_layout_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.assetlayoutgroup')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.assetsitegroup'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('name', models.CharField(max_length=150)),
                ('max_width', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(3)])),
                ('max_height', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(3)])),
                ('description', models.TextField(null=True)),
                ('asset_item_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.assetitemgroup')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('absence_type', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.absencetype')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
            ],
            options={
                'unique_together': {('absence_type', 'absence_start_date', 'absence_end_date', 'user')},
            },
        ),
        migrations.CreateModel(
            name='Absence',
            fields=[
                ...
                ('description', models.TextField(null=True)),
                ('is_accepted', models.BooleanField(null=True)),
                ('absence_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.absencegroup')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='backend.user')),
            ],
            options={
                'abstract': False,
